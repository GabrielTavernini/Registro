...
{
    public class ArgsCell : ViewCell
    {
        ...
        public ArgsCell()
        {
            ...
            //-----------------Bindings-----------------
            this.SetBinding(VoidProperty, nameof(ArgsModel.Void));
            this.SetBinding(ItemIdProperty, nameof(ArgsModel.Id));
            gradeL.SetBinding(Label.TextProperty, nameof(ArgsModel.FirstLetter));
            gradeF.SetBinding(ShapeView.ColorProperty, nameof(ArgsModel.color));
            subjectL.SetBinding(Label.TextProperty, nameof(ArgsModel.subject));
            typeL.SetBinding(Label.TextProperty, nameof(ArgsModel.Preview));
            dateL.SetBinding(Label.TextProperty, nameof(ArgsModel.date));
        }
