...
namespace Registro.Models
{
    public class NoteCell : ViewCell
    {
        ...
        public NoteCell()
        {
            ...
            //-----------------Bindings-----------------
            this.SetBinding(VoidProperty, nameof(NoteModel.Void));
            this.SetBinding(ItemIdProperty, nameof(NoteModel.Id));
            gradeL.SetBinding(Label.TextProperty, nameof(NoteModel.FirstLetter));
            gradeF.SetBinding(ShapeView.ColorProperty, nameof(NoteModel.color));
            subjectL.SetBinding(Label.TextProperty, nameof(NoteModel.Nome));
            typeL.SetBinding(Label.TextProperty, nameof(NoteModel.Preview));
            dateL.SetBinding(Label.TextProperty, nameof(NoteModel.date));
        }
